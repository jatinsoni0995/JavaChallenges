...
public class FeeStructure extends JFrame{
    ...
    public FeeStructure(){
        ...
        i1.setFont(new Font("times new roman",Font.BOLD,56));
        i1.setBounds(550,10,400,70);
        add(i1);
        ...
        l14.setFont(new Font("serif",Font.BOLD,22));
        add(l14);

        l15 = new JLabel("Semester 6");
        l15.setBounds(80,520,150,40);
        l15.setFont(new Font("serif",Font.BOLD,22));
        add(l15);

        l16 = new JLabel("Semester 7");
        l16.setBounds(80,590,150,40);
        l16.setFont(new Font("serif",Font.BOLD,22));
        add(l16);

        l17 = new JLabel("Semester 8");
        l17.setBounds(80,660,150,40);
        l17.setFont(new Font("serif",Font.BOLD,22));
        add(l17);
        ...
        bb3.setFont(new Font("serif",Font.PLAIN,22));
        add(bb3);

        bb4 = new JLabel("Rs 32000");
        bb4.setBounds(480,380,100,40);
        bb4.setFont(new Font("serif",Font.PLAIN,22));
        add(bb4);

        bb17 = new JLabel("Rs 32000");
        bb17.setBounds(480,450,100,40);
        bb17.setFont(new Font("serif",Font.PLAIN,22));
        add(bb17);

        bb18 = new JLabel("Rs 32000");
        bb18.setBounds(480,520,100,40);
        bb18.setFont(new Font("serif",Font.PLAIN,22));
        add(bb18);
